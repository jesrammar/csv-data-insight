          ...
          <div className="card">
            ...
            {!data?.gestores?.length ? (
              ...
              <table className="table">
                <thead>
                  <tr>
                    <th className="cursor-pointer" onClick={() => toggleGestorSort('gestor')}>
                      Gestor{sortMark('gestor')}
                    </th>
                    <th className="cursor-pointer" onClick={() => toggleGestorSort('total')}>
                      Total{sortMark('total')}
                    </th>
                    <th className="cursor-pointer" onClick={() => toggleGestorSort('active')}>
                      Activos{sortMark('active')}
                    </th>
                    <th className="cursor-pointer" onClick={() => toggleGestorSort('minuta')}>
                      Minuta media{sortMark('minuta')}
                    </th>
                    <th className="cursor-pointer" onClick={() => toggleGestorSort('carga')}>
