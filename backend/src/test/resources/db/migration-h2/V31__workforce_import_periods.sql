...
-- H2 does not support PostgreSQL partial indexes. The production migration
-- enforces the one-active-import-per-period invariant at database level; tests
-- exercise the same invariant through the service layer.
